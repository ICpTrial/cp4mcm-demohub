This tutorial as well as other linked ones were designed to run using the following environment: [https://bluedemos.com/show/3915](https://bluedemos.com/show/3915) available also throught IBM DTE 2.0 portal [https://dte2.us1a.cirrus.ibm.com/show/3915]
このチュートリアルは、IBM Digitail Engage Environemnt (DTE) 2.0環境で提供さえる IBM Cloud Pak for Multicloud Management 2.2 の環境に基づいています。
IBM 社内のかたは [DTE MCM 2.2](https://assetrepo.ibm.com/collection/ibm-cloud-pak-for-multicloud-management-2-0)の環境より、環境を払出してご利用ください。
