...
1. アサインされた ibmuserXX のブランチを開きます（ここを間違えると、ハンズオンを実施している他の人の定義を変更してしまいますのでご留意ください)。
![image](https://user-images.githubusercontent.com/22209835/115819192-50c34e00-a439-11eb-8b77-e981644ccd87.png)
