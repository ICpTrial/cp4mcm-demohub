...
![image](https://user-images.githubusercontent.com/22209835/113955299-68ee7700-9856-11eb-8cd9-853d1931a7b0.png)  
   ...
   1. レポジトリ情報として、以下の情報を指定してください。
        |項目|値|備考|
        --|--
        |URL|https://github.com/ICpTrial/ModernResortXX| XXは 01-06のセミナー管理者によってアサインされた番号です| 
...
1. ブラウザで、アサインされた **modresort** の Gitページを開きます。https://github.com/ICpTrial/ModernResortXX XXは、アサインされた番号です。
