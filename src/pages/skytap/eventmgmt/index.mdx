...
1. このハンズオンでは、すでに 事前に用意されているSlackを利用します。    
    ...
    |ユーザー|URL|参考出力先チャネル|
    --|--|--
    |01|https://hooks.slack.com/services/ T01UHUAGNHZ/B01V9L3JYAF/lzZMDbmkvJlWmuUruNhkGxk9|cp4mcmlab01|
    |02|https://hooks.slack.com/services/ T01UHUAGNHZ/B01V9LHD59R/PxfEoHy0fzRR4altyUKf9ZyE|cp4mcmlab02|
    |03|https://hooks.slack.com/services/ T01UHUAGNHZ/B020K8N2AJU/QGt1lqIAV5fAN9M9XN7G5IvE|cp4mcmlab03|
    |04|https://hooks.slack.com/services/ T01UHUAGNHZ/B01V9LQR07M/ha840FLAU0ZwVOPM5U2Sfp6D|cp4mcmlab04|
    |05|https://hooks.slack.com/services/ T01UHUAGNHZ/B01V9ELGY4A/6SgS5rXMYL2XvX9GHMor9vuX|cp4mcmlab05|
    |06|https://hooks.slack.com/services/ T01UHUAGNHZ/B01V2M7QZK8/DgYhAW7gz51LI84I07VG6Pkc|cp4mcmlab06|
...
### Runbook Automationに利用する Ainsileの定義
...
1. IBM Cloud Pak for Multicloud Managementのコンソールに戻り、Administer>Monitoringから、**Runbooks**を開きます。
    ...
    **Automations**は、発生したイベントへの対応として、オペレーターによって手動でキックされるか、自動で実行されることができる処理です。  
    ...
    ![image](https://user-images.githubusercontent.com/22209835/115179938-6e2daa80-a10f-11eb-9355-854ef2bab6e6.png)認のポップアップでは、**Apply**をクリックします。
...
１. また自動的に EventPolicyによって、runbook（作業手順書）が関連付けられていることを確認します。
