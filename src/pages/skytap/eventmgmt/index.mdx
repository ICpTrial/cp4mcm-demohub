...
ご自身のSlack ワークスペースで作業する場合には、 ** Slackの統合の設定方法 **をご参照ください。 
...
ご自身が利用している ワークスペースで試す場合、または新規に作成したトライアルのワークスペースで試すには、以下の手順を実施します。
...
1. 連携する チャネルを選択し、**Incoming WebHookインテグレーションの追加** をクリックします。
