...
![image](https://user-images.githubusercontent.com/22209835/115893636-67968e80-a493-11eb-87a8-e6a54fc68b8c.png)
3. いま一度サンプル・イベントを生成し、暫く待つとイベントの情報を含む インシデントの通知が Slackに飛びます。
