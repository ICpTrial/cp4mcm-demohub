...
1. IBM Cloud Pak for Multicloud Managementのコンソールに戻り、Administer>Monitoringから、**Runbooks**を開きます。
    ...
    **Automations**は、発生したイベントへの対応として、オペレーターによって手動でキックされるか、自動で実行されることができる処理です。  
    ...
    ![image](https://user-images.githubusercontent.com/22209835/115179647-c4e6b480-a10e-11eb-937f-c9de6b6440f8.png)
        1. 名前を を **Online Banking Application Auto Restart** として、**Add automation Step **ボタンをクリックします。 
    ...
    1. 
    ![image](https://user-images.githubusercontent.com/22209835/115180030-9ddcb280-a10f-11eb-9d1d-4e894eefe9d0.png)
